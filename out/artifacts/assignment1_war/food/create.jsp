...
<nav class="navbar navbar-expand-lg navbar-light bg-secondary">
    ...
    <div class="container">
        ...
        <form action="/food/create" method="post">
            ...
            <div class="form-group">
                <label>Ảnh</label>
                <input type="text" name="name" class="form-control" placeholder="Nhập ảnh món ăn">
            </div>
            <div class="form-group">
                <label>Mô tả</label>
                <textarea type="text" name="descriptions" class="form-control" placeholder="Nhập mô tả" style="resize: vertical;"></textarea>
            </div>
